        ...
        jPanel6Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel6Layout.createSequentialGroup()
                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        .addComponent(jPanel9, javax.swing.GroupLayout.PREFERRED_SIZE, 568, javax.swing.GroupLayout.PREFERRED_SIZE)
...
/**
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        DtoolLogControl.log("======================================EXECUTANDO QUERY==================================", Level.WARNING);
            ...
            protected Object doInBackground() throws Exception {
                ...
                if (jTextArea2.getText().indexOf("@Value(") > 0) {
                    ...
                    DtoolDqlControl.executeQuery(jTextArea2.getText(), jTable1, (String) jComboBox1.getSelectedItem(),
                            (String) jComboBox2.getSelectedItem(), jTextArea2Edited, dtoolJFrame.dateFormat, dtoolJFrame);
                    ...
                    if (queryTableModel.getMaxRowsCount() >= 1000001) {
                        DtoolLogControl.log("Esta query exedeu o número de linhas suporatada pela aplicação (1.000.000)", Level.SEVERE);
                        maxRows += " - Loaded Aborted";
                    }
    ...
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton11ActionPerformed
        ...
        dtoolJFrame.STOP = true;//Bloqueia a execução da carga se estiver preenchendo o grid.       
        try {
        ...
        if (!workerQuery.isDone()) {
            workerQuery.cancel(true);
        }

        dtoolJFrame.STOP = false;

        jButton11.setEnabled(
                false);
        DtoolLogControl.log(
                "A execução da query foi cancelada", Level.WARNING);
    ...
    private void jButton15ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton15ActionPerformed
        DtoolLogControl.log("======================================EXPORTAÇÃO DE REGISTROS==================================", Level.WARNING);
        try {
            importToGrid();
        } catch (IOException ex) {
            DtoolLogControl.log(ex, Level.SEVERE);
