...
/**
    ...
    */
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
       ...
       if (keyPressed) {
          ...
          String foo = (String) jTable1.getModel().getValueAt(row, col);
          dtoolJFrame.operationControl(dtoolJFrame.OP_DUMP, true, new String[]{foo});
    ...
    */
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
       ...
       /**
        * if (workerExport != null && !workerExport.isDone()) { DtoolLogControl.log("Processo já em execução",
        ...
        *
        * chooser.setCurrentDirectory(new java.io.File(".")); chooser.setDialogTitle("Selecione um arquivo ou crie um
        * novo"); chooser.setFileSelectionMode(JFileChooser.FILES_ONLY); chooser.setAcceptAllFileFilterUsed(false);
        *
        ...
        *
        * if (chooser.showSaveDialog(dtoolJFrame) == JFileChooser.APPROVE_OPTION) { LoginTableModel tm =
        * (LoginTableModel) jTable1.getModel(); try { DtoolCSVControl.processCSV(chooser.getSelectedFile(),
        * tm.getRows(), tm.getColumns()); } catch (IOException ex) { DtoolLogControl.log(ex, Level.SEVERE); }
        * DtoolLogControl.log("Query exportada com sucesso em: " + chooser.getSelectedFile(), Level.INFO); } else {
        *
