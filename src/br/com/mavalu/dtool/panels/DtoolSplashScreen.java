...
public class DtoolSplashScreen {

    private JDialog dialog;
    private JFrame frame;
    private JProgressBar progress;    

    public void initUI(DtoolJFrame dt) throws MalformedURLException {
    ...
    protected void showSplashScreen() throws MalformedURLException {
        ...
        ImageIcon img = new ImageIcon("./img/dtool Logo1.png");
       ...
       //background.add(text);
        ...
        progress.setToolTipText("Loading, please wait...");
        dialog.pack();
    ...
    protected void showFrame() {
        frame = new JFrame(DtoolSplashScreen.class.getSimpleName());
