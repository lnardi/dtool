 ...
 * @author q1D55V6G
 */
public class ExportPanel extends DToolJPanel {
    ...
    private static boolean exportServerPath = false;
    private static boolean exportConcatenet = false;
    ...
    ExportPanel(JDialog jd, DtoolJFrame dt, LoginTableModel ltm, String q) throws IOException {
        ...
        jCheckBox6.setSelected(exportConcatenet);
    ...
    private void initComponents() {
        ...
        jCheckBox6.setText("Quando r_object_id for repetido concatenar conlunas com valores diferentes");
   ...
   private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
       ...
       String csvFile_1 = jTextField1.getText() + "\\" + temp[0] + "._1" + temp[1];

       File f = new File(csvFile);
       File f_1 = new File(csvFile_1);
       if ((f.exists() && !f.isDirectory()) || (f_1.exists() && !f_1.isDirectory())) {
           Object[] options = {"Sim",
               "Não"};

           int opt = JOptionPane.showOptionDialog(this.dtoolJFrame,
                   "Neste caminho já existe um arquivo com mesmo nome. Sobrescrever?",
                   "PERIGO!!!!",
       ...
       SwingWorker workerQuery = new SwingWorker() {
           ...
           protected Object doInBackground() throws Exception {
               ...
               try {
                   ...
                   exportServerPath = jCheckBox4.isSelected();
                   exportConcatenet = jCheckBox6.isSelected();
                   ...
                   if (jCheckBox1.isSelected() || jCheckBox4.isSelected()) {
                       ...
                       ec = DtoolExportControl.exportQueryGridThreads(csvFile,
                               loginTableModel.getRows(), loginTableModel.getColumns(), jCheckBox1.isSelected(), jRadioButton1.isSelected(), jComboBox1.getSelectedIndex(), dtoolJFrame, (jCheckBox2.isSelected() ? split_line_number : 0), jCheckBox3.isSelected(), jTextField3.getText(), numberOfThreads, jCheckBox4.isSelected(), jCheckBox5.isSelected(), jCheckBox6.isSelected(), jTextField4.getText());
           ...
           protected void done() {
               dtoolJFrame.operationControl(dtoolJFrame.OP_PROGRESS_BAR, false, null);               
               //Se está expotando manipulando a lista, atualiz
               if (jCheckBox6.isSelected()) {                
                   dtoolJFrame.operationControl(dtoolJFrame.OP_REFRESH_QUERY_RESULT_TABLE, false, null);
               } else {
                   dtoolJFrame.operationControl(dtoolJFrame.OP_EXPORT, true, null);
               }
           }
   ...
   private void jRadioButton3StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jRadioButton3StateChanged
    ...
    private void updateSplitFileOption() {
        if (loginTableModel.getMaxRowsCount() > ((Long) jSpinner1.getValue())) {
