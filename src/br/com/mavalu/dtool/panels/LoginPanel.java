...
public class LoginPanel extends javax.swing.JPanel {
    ...
    */
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
       ...
       /**
        * if (jList1.getSelectedValue() == null) { DtoolLogControl.log("Uma das docbases deve ser selecionada",
        * Level.INFO); } else { DtoolLoginControl.login((String) jList1.getSelectedValue(), jTextField1.getText(),
        * String.copyValueOf(jPasswordField1.getPassword())); DtoolLogControl.log("Logado com sucesso!!! ", Level.INFO);
        * }
        *
        */
